...
while True:
    ...
    if EXECUTE:
        ...
        maskZone = cv.inRange(hsv, lower_red, upper_red)
        ...
        contoursAncrage, hierarchy = cv.findContours(maskZone, cv.RETR_EXTERNAL, cv.CHAIN_APPROX_SIMPLE)
